...
@section('title')
    Portfolio details| Devs Ease ltd
@endsection
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img width="850px" height="430px" src="{{ asset($portfolioPage->portfolio_image) }}" alt="">
                    </div>
                    <div class="services__details__content">
                        <h2 class="title">{{ $portfolioPage->portfolio_name }}</h2>

                        {!! $portfolioPage->portfolio_desc !!}
