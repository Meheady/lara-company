            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center">Update Portfolio</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('update.portfolio',['id'=>$portfolio->id]) }}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="row form-group mb-2">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="{{ $portfolio->portfolio_name }}" name="portfolio_name" class="form-control">
                                </div>
                            </div>
                            <div class="row form-group mb-2">
                                <label for="" class="col-md-2 col-form-label">Portfolio Title</label>
                                <div class="col-md-9">
                                    <input type="text" value="{{ $portfolio->portfolio_title }}" name="portfolio_title" class="form-control">
                                </div>
                            </div>
                            <div class="row form-group mb-2">
                                <label for="" class="col-md-2 col-form-label">Portfolio Description</label>
                                <div class="col-md-9">
                                    <textarea id="elm1" name="portfolio_desc">{{$portfolio->portfolio_desc}}</textarea>
                                </div>
                            </div>
                            <div class="row form-group mb-2">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <img id="showImage" src="{{ asset($portfolio->portfolio_image) }}"  width="100px" height="100px" alt="">
                                </div>
                            </div>
